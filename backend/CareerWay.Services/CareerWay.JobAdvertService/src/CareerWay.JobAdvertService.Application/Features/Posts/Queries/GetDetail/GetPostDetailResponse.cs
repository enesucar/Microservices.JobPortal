...
public class GetPostDetailResponse
{
    ...
    public List<GetPostPostEducationLevelDetailResponse> EducationLevels { get; set; } = [];

    public List<GetPostPostLanguageRequirementDetailResponse> LanguageRequirements { get; set; } = [];

    public List<GetPostPostMilitaryStatusDetailResponse> MilitaryStatuses { get; set; } = [];

    public DateTime? PublicationDate { get; set; }

    public DateTime? ExpirationDate { get; set; }

    public List<GetPostPostSectorDetailResponse> Sectors { get; set; } = [];

   // public List<GetPostPostSkillDetailResponse> Skills { get; set; } = [];

    public List<GetPostWorkBenefitDetailResponse> WorkBenefits { get; set; } = [];
}


public class GetPostWorkBenefitDetailResponse
{
    public long Id { get; set; }
