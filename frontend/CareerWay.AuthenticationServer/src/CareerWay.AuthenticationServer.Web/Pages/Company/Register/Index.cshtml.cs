...
public class IndexModel : PageModel
{
    ...
    public IndexModel(IIdentityServerInteractionService interaction, IClientStore clientStore, IAuthenticationSchemeProvider schemeProvider, IIdentityProviderStore identityProviderStore, IRegistrationClient registrationClient)
    {
    ...
    public async Task<IActionResult> OnPost()
    {
        ...
        {
            var response = await _registrationClient.Create(new Models.CreateCompanyRequest()
            {
                Email = Input.Email,
            ...
            if (response.Success)
            {
                ...
                isuser.AdditionalClaims.Add(new Claim(ClaimTypes.Role, "Company"));
